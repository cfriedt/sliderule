 ...
 * this parameter to be known by, and add this annotation. SlideRule will inject a value for this
 ...
 * <li>Otherwise, if the parameter type is either {@code boolean} or an {@code enum} type, SlideRule
 *     assumes you want all possible values.
 * <li>Finally, if none of the above match, SlideRule will display an error and exit.
 * </ul>
 *
 * <p>SlideRule parameters are always strings, but can be converted to other types at the point of
 ...
 *
 * <p>SlideRule will test every possible combination of parameter values for your benchmark. For
 * example, if you have two parameters, {@code -Dletter=a,b,c -Dnumber=1,2}, SlideRule will construct
